...
function hexToRgb(hex) {
    var match = /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})$/i.exec(hex);
    return {
...
/**
 * Sends set color command
 * @param {String} color in format "#rrggbb"
 * @param {Function} callback
 * @return {this}
 */
Controller.prototype.setColor = function(hex, callback){
    var rgb = hexToRgb(rgb);
    var hsl = rgbToHsl(rgb.r, rgb.g, rgb.b);
    var hue = hsl.hue / 360 * 255;
    this.sendCommand(SET_COLOR_CMD, callback, hue);
    return this;
};
